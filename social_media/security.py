...
# --- START MONKEY PATCH ---
# Fix for passlib incompatibility with bcrypt >= 4.0.0
# We patch bcrypt to silently truncate passwords to 72 bytes,
# restoring the behavior passlib expects.
...
def create_access_token(email: str):
    logger.debug("createing access token", extra={"email": email})
